/*===========================================================================================
    ...
    Due date:    May 9, 2016
    File name:   syntax.y
    Purpose:     Determines whether there are or aren't syntax errors in the program.
===========================================================================================*/
%{
 	#ifndef YYSTYPE
   	#define YYSTYPE char*
...
PRGRM
	: PROGRAM
	| id {yyerror("PROGRAM is spelled wrong");}
	;
var
...
begEnd
	...
	| statlist {yyerror("BEGIN is expected");}
	;
begstate	
	: BEG  
...
print
	...
	| id LEFT_PAREN {yyerror("PRINT is spelled wrong");}
    	| LEFT_PAREN {yyerror("PRINT is expected");}
    	| PRINT output {yyerror("( is missing");}
    	| PRINT LEFT_PAREN output semicolon {yyerror(") is expected");}
